...
if ($saveStatus == 'E') {
    $vTitle = $edit_patient[0]->vTitle;
    $vUserName = $edit_patient[0]->vUserName;
    $vFirstName = $edit_patient[0]->vFirstName;
    $id = $edit_patient[0]->id;
    $vLastName = $edit_patient[0]->vLastName;
    $dRegDate = $edit_patient[0]->dRegDate;
    $cEnable = $edit_patient[0]->cEnable;
    $vEmail = $edit_patient[0]->vEmail;
    $vContactNo = $edit_patient[0]->vContactNo;
    $iUserType = $edit_patient[0]->iUserType;
    $tAddress = $edit_patient[0]->tAddress;
            ...
            <div class="col-lg-8">                
                <ul id="sparks" class="">
                    <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 22px 15px; min-width: auto;">
                        <a href="<?php echo base_url("adminpanel/master/patient/add_patient"); ?>"><h5>Add New</h5></a>                       
                    </li>
                    <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto;">
                        <a href="<?php echo base_url("adminpanel/master/patient/view_patient"); ?>"><h5>View All<span class="txt-color-blue" style="text-align: center"><i class=""></i><?php echo count($list_data); ?></span></h5></a>                       
                    </li>
                </ul>
            </div> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td align='center'> 
                                                        <div class="control-buttons" style="font-size: 15px;">  
                                                            <a href="<?php echo base_url("adminpanel/master/patient/edit_patient/$recordid"); ?>" title="Modify"><i class="fa fa-edit" style=" text-align: center"></i></a>
                                                        </div>
                                                    </td>
                                                    <td align='center'> 
                                                        <div class="control-buttons" style="font-size: 15px;">  
                                                            ...
                                                            <?php 
                                                                if ($recordid != '1') {
                                                            ?>
                                                            <a href="<?php echo base_url("adminpanel/master/patient/delete_record/$recordid"); ?>" onclick="return confirm('Are you sure?')" title="Delete"><i class=" fa fa-trash" style=" text-align: center"></i></a>
                                                                <?php }else {?>
                                                            &nbsp; &nbsp; &nbsp;&nbsp;
                                                                <?php } ?>
                                                        </div>
                                                        ...
                                                        <span class="onoffswitch-switch"></span>
                                                            ...
                                                            $('#inline_<?php echo $recordid; ?>').on('change', function (e) {
                                                                if ($(this).prop('checked')) {
                                                                    window.location.href = '<?php echo base_url("adminpanel/master/patient/active_record/$recordid"); ?>';
                                                                } else {
                                                                    window.location.href = '<?php echo base_url("adminpanel/master/patient/deactive_record/$recordid"); ?>';
                                                                }
                                                            });
...
<!--add and view-->
            <div class="jarviswidget" id="user_register">
                ...
                <div>
                    <div class="widget-body no-padding">
                        <form action="<?php echo base_url("adminpanel/master/patient/save_user"); ?>" method="post" id="user_register-form" class="smart-form">
                            <header>
                                <?php echo $title; ?>
                            </header>
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-1">
                                        ...
                                        <label class="select">
                                            <select name="vTitle" id="vTitle" onchange="show_guardian();">
                                ...
                                <div class="row">
                                   <section class="col col-6">
                                    ...
                                    <section class="col col-6" style=" display: none"> 
                                        <label class="label">Patient Type <span style=" color: red">*</span></label>
                                        <label class="select">
                                            <select name="iUserType" id="iUserType" >
                                                <!-- <option value="" selected=""  >Patient Type</option> -->
                                ...
                                <div  id="div1" <?php if($showbutton != 'add_patient'){ ?> style=" display: none" <?php } ?>>
                                    <div class="row">
                                        <section class="col col-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6" id="sec1" <?php if($showbutton != 'add_patient'){ ?> style=" display: none" <?php } ?>>
...
$('#vFirstName').keyup(function() {
    ...
    {//alert(username);
        ...
        $.ajax({
                ...
                url: "<?php echo base_url() ?>adminpanel/master/patient/check_username",   
    ...
    function viewlist() {
        ...
        document.location = '<?php echo base_url("adminpanel/master/patient/view_patient"); ?>';
    }
